...
from omninexus.core import logger
...
def get_llm_config_arg(
    ...
    logger.omninexus_logger.debug(f'Loading llm config from {llm_config_arg}')
    ...
    try:
        ...
        logger.omninexus_logger.error(f'Config file not found: {e}')
        return None
    except toml.TomlDecodeError as e:
        logger.omninexus_logger.error(
    ...
    logger.omninexus_logger.debug(f'Loading from toml failed for {llm_config_arg}')
    return None
