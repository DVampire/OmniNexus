...
from omninexus.agenthub.browsing_agent.response_parser import BrowsingResponseParser
...
class BrowsingAgent(Agent):
    ...
    def step(self, state: State) -> Action:
        ...
        # we should also send a message back to the user in omninexus and call it a day
        if (
