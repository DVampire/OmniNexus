...
from omninexus.events.action import CmdRunAction
from omninexus.events.observation import ErrorObservation
...
class BashSession:
    ...
    def initialize(self):
        ...
        session_name = f'omninexus-{self.username}-{uuid.uuid4()}'
