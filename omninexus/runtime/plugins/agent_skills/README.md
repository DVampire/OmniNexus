# omninexus Skill Sets

This folder implements a skill/tool set `agentskills` for omninexus.
...
The skill set can contain a bunch of wrapped tools for agent ([many examples here](https://github.com/All-Hands-AI/omninexus/pull/1914)), for example:
