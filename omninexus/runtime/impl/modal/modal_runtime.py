...
from omninexus.runtime.impl.eventstream.eventstream_runtime import (
    EventStreamRuntime,
    LogBuffer,
)
...
from omninexus.runtime.utils.runtime_build import (
    BuildFromImageType,
    prep_build_folder,
)
...
class ModalRuntime(EventStreamRuntime):
    ...
    container_name_prefix = 'omninexus-sandbox-'
    ...
    def __init__(
        ...
        self.app = modal.App.lookup(
            'omninexus', create_if_missing=True, client=self.modal_client
        )
