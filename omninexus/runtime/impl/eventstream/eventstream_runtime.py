...
from omninexus.core.logger import DEBUG
...
from omninexus.events.serialization import event_to_dict, observation_from_dict
...
from omninexus.runtime.impl.eventstream.containers import remove_all_containers
from omninexus.runtime.plugins import PluginRequirement
from omninexus.runtime.utils import find_available_tcp_port
from omninexus.runtime.utils.request import send_request
    ...
    def _init_container(self):
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                command=(
                    f'/omninexus/micromamba/bin/micromamba run -n omninexus '
                    f'poetry run '
                    f'python -u -m omninexus.runtime.action_execution_server {self._container_port} '
                    f'--working-dir "{self.config.workspace_mount_path_in_sandbox}" '
                    f'{plugin_arg}'
                    f'--username {"omninexus" if self.config.run_as_omninexus else "root"} '
