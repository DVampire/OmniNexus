...
from omninexus.runtime.base import (
    Runtime,
    RuntimeDisconnectedError,
    RuntimeNotReadyError,
)
from omninexus.runtime.builder.remote import RemoteRuntimeBuilder
from omninexus.runtime.plugins import PluginRequirement
from omninexus.runtime.utils.command import get_remote_startup_command
from omninexus.runtime.utils.request import (
    send_request,
)
...
class RemoteRuntime(Runtime):
    ...
    def _start_runtime(self):
        ...
        command = get_remote_startup_command(
            ...
            'omninexus' if self.config.run_as_omninexus else 'root',
