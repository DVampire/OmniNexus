...
from omninexus.events.observation import Observation
...
from omninexus.security.analyzer import SecurityAnalyzer
from omninexus.security.invariant.client import InvariantClient
from omninexus.security.invariant.parser import TraceElement, parse_element
...
class InvariantAnalyzer(SecurityAnalyzer):
    ...
    input: list[dict]
    container_name: str = 'omninexus-invariant-server'
    image_name: str = 'ghcr.io/invariantlabs-ai/server:omninexus'
